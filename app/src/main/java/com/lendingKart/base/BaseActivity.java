...
public abstract class BaseActivity extends AppCompatActivity implements IFragmentInteractionListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_justdental_base);
        initViews();
    }

    protected void addContentView(int layoutId) {
        FrameLayout fragmentContainer = (FrameLayout) findViewById(R.id.fragment_container);
        View view = LayoutInflater.from(this).inflate(layoutId, fragmentContainer, false);
    ...
    public void updateToolbar(IToolbar toolbar) {
        setHeadeToolBarValues(toolbar.getHeaderLeftIconId(), toolbar.getToolbarTitleId(),
                toolbar.getHeaderRightIconId());
    ...
    protected final void setHeadeToolBarValues(int headerLeftIconId, String toolbarTitle, int headerRightIconId) {
