...
public class AlertDialogFragment extends BaseDialogFragment {
    ...
    private static final String NEGATIVE_ACTION_BTN_TEXR = "negative";
    ...
    public static AlertDialogFragment create(String title, String message, String positveBtnText,
        ...
        bundle.putString(NEGATIVE_ACTION_BTN_TEXR, negativeBtnText);
    ...
    private void setValues() {
        ...
        if (dataBundle != null) {
            ...
            setActions(dataBundle.getString(POSITIVE_ACTION_BTN_TEXT), dataBundle.getString(NEGATIVE_ACTION_BTN_TEXR));
        } else {
            dismiss();
        }
